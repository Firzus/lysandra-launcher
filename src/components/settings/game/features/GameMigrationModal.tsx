                        ...
                        <ModalBody className="gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="rounded-lg bg-default-100 p-3">
                                    <p className="text-muted-foreground break-all text-sm">{currentPath}</p>
                                </div>
                            </div>
                            ...
                            <div className="rounded-lg border border-warning-200 bg-warning-50 p-3">
                                <div className="flex items-start gap-2">
                                    <LuTriangleAlert className="mt-0.5 text-warning-600" size={16} />
                                    <div className="space-y-1">
                                        <p className="text-sm font-medium text-warning-800">Attention</p>
                            ...
                            {migrationError && (
                                <div className="rounded-lg border border-danger-200 bg-danger-50 p-3">
                                    <p className="text-sm text-danger-800">{migrationError}</p>
                                </div>
                            )}
                        </ModalBody>
